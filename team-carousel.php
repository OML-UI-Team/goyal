...
<head>
        <title>Goyal eye | Best Eye Hospital in East Delhi, Eye Care Center in Delhi,Eye Hospital  in West Delhi</title>
        <meta charset="utf-8">
                    ...
                    <div class="col-auto text-right hidden-xs pr-0 font-size-0">
                        <div class="header-search-icon search-form-wrapper">
                            ...
                            <div class="form-wrapper">
                                ...
                                <form id="search-form" role="search" method="get" class="search-form text-left" action="https://lithohtml.themezaa.com/search-result.html">
                            ...
                            <ul class="dropdown-menu cart-item-list">
                                <li class="cart-item align-items-center">
                                    ...
                                    <div class="product-image">
                                        <a href="single-product.html"><img src="images/cart-image-01.jpg" class="cart-thumb" alt="" /></a>
                                    </div>
                                ...
                                <li class="cart-item align-items-center">
                                    <a href="javascript:void(0);" class="alt-font close">×</a>
                                    <div class="product-image">
                                        <a href="single-product.html"><img src="images/cart-image-02.jpg" class="cart-thumb" alt="" /></a>
                                    </div>
                                    <div class="product-detail alt-font">
            ...
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    <div class="col-12 col-xl-8 col-lg-6">
                        <!-- start page title -->
                        <h1 class="alt-font text-white font-weight-500 no-margin-bottom text-center text-lg-left">Team carousel</h1>
                        <!-- end page title -->
                    </div>
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="team-style-01 text-center">
                                        <figure class="border-radius-5px">
                                            <div class="team-member-image">
                                                <img alt="" src="images/home-events-conference-img-06.jpg">
                                                <div class="team-overlay bg-transparent-gradient-sky-blue-pink border-radius-5px"></div>
                                            </div>
                                            <figcaption class="align-items-center justify-content-center d-flex flex-column padding-20px-lr padding-30px-tb">
